...
public class C01_ArrayList {
    public static void main(String[] args) {
        ...
        arr=C10_ArrayeBirElementEkleme.arrayeElemanEkleme(arr,"C");
        ...
        // elementleri sedece tek tek ekleyebiliriz

        // peki bir ArrayList nasıl Olusturulur
        ...
        System.out.println(harfler); // [A, C, B, K]  --> B ile K arasinda D ekleyeli
